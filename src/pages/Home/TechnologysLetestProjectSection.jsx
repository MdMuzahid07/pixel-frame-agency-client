...
const TechnologysLetestProjectSection = () => {
    return (
        <div className='lg:max-w-screen-lg mx-auto my-20'>
            ...
            <div class="md:flex justify-between items-center customHero">
                <div className='md:flex items-center'>
                    <h1 class="latest-project-font font-bold">02/</h1>
                    <div>
                        <h2 className='text-xl text-white font-bold'>DEVELOPMENT | TECHNOLOGY</h2>
                        <h2 className='text-2xl text-white font-bold'>Technology Process</h2>
                    </div>
            ...
            <div class="md:flex justify-between items-center customHero">
                <div className='md:flex items-center'>
                    <h1 class="latest-project-font font-bold">03/</h1>
                    <div>
                        <h2 className='text-xl text-white font-bold'>DEVELOPMENT | TECHNOLOGY</h2>
                        <h2 className='text-2xl text-white font-bold'>Technology Process</h2>
                    </div>
            ...
            <div class="md:flex justify-between items-center customHero">
                <div className='md:flex items-center'>
                    <h1 class="latest-project-font font-bold">04/</h1>
                    <div>
                        <h2 className='text-xl text-white font-bold'>DEVELOPMENT | TECHNOLOGY</h2>
                        <h2 className='text-2xl text-white font-bold'>Technology Process</h2>
                    </div>
...
export default TechnologysLetestProjectSection;